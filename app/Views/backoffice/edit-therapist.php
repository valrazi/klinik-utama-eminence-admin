    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="generalForm" method="post" action="<?= base_url('backoffice/therapists/update/' . $doctor['id']) ?>">
                    <?= csrf_field() ?>
                    ...
                    <a href="<?= base_url('backoffice/therapists') ?>" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
